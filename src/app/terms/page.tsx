                ...
                <div className="prose prose-invert max-w-none">
                    <div className="bg-neutral-900 border border-neutral-700 rounded-lg p-4 mb-8">
                        <p className="text-gray-300 text-sm">
                            ...
                            <strong>Address:</strong> 1305 S Marine St, Santa Ana, CA 92704<br/>
                            <strong>Phone:</strong> 5104232516<br/>
                            <strong>Email:</strong> tdombui@gmail.com
                        </p>
                    </div>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-300 mb-4">
                            We are GanbattePM (&ldquo;Company,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; &ldquo;our&rdquo;), a company registered in California, United States at 1305 S Marine St, Santa Ana, CA 92704.
                        </p>
                        <p className="text-gray-300 mb-4">
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-300 mb-4">
                            You can cancel your subscription at any time by logging into your account. Your cancellation will take effect at the end of the current paid term. If you have any questions or are unsatisfied with our Services, please email us at tdombui@gmail.com.
                        </p>
                    ...
                    <section className="mb-8">
                        ...
                        <p className="text-gray-300 mb-6">
                            If you have any questions or need assistance regarding our SMS communications, please email us at tdombui@gmail.com or call at 5104232516.
                        </p>
                    </section>
