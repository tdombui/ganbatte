      ...
      <div className="min-h-screen bg-neutral-950">
        ...
        <div className="flex justify-center items-center min-h-screen">
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white mb-4">Please sign in to view your jobs</h1>
            <Link
              href="/auth"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {jobsLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-neutral-400 mb-6">Create your first delivery job to get started</p>
              <Link
                href="/chat"
                className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2 px-4 rounded-md transition-colors"
              >
