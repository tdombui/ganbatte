...
export default function CustomerNavbar() {
    ...
    const handleLogout = async () => {
        try {
            console.log('🔍 CustomerNavbar: Starting logout...')
            console.log('🔍 CustomerNavbar: Current user:', user?.id)
            console.log('🔍 CustomerNavbar: Is authenticated:', isAuthenticated)
                                            ...
                                            <div className="absolute right-0 mt-2 w-48 bg-black/95 backdrop-blur border border-gray-800 rounded-lg shadow-lg py-2 z-50">
                                                ...
                                                <button
                                                    onClick={(e) => {
                                                        e.preventDefault()
                                                        e.stopPropagation()
                                                        console.log('🔍 CustomerNavbar: Desktop Sign Out button clicked')
                                                        handleLogout()
                                                    }}
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <button
                                                onClick={(e) => {
                                                    e.preventDefault()
                                                    e.stopPropagation()
                                                    console.log('🔍 CustomerNavbar: Mobile Sign Out button clicked')
                                                    handleLogout()
                                                }}
